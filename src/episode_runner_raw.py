...
def run_once(model, env: gym.Env, max_steps: int, show_observation: bool, show_action: bool):    
...
def run_once_thin(model, env: gym.Env, max_steps: int):    
    observation, _ = env.reset()
    fitness = 0.0
...
def run_simulation(models: list, 
